...
Sal runs the biggest shipping company in the tri-county area, Sal’s Shippers. Sal wants to make sure that every single one of his customers has the 
best, and most affordable experience shipping their packages.
...
print("- Ground Shipping Cost $" + "{:.2f}".format(ground_shipping_cost))
print("")
...
print("- Ground Premium Cost $" + "{:.2f}".format(ground_premium_cost))
print("")
...
print("- Drone Shipping Cost $" + "{:.2f}".format(drone_shipping_cost))
